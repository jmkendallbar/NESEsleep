---
title: "Sleep in northern elephant seals (*Mirounga angustirostris*)"
author:
  - Jessica M. Kendall-Bar:
      correspondence: "yes"
      email: jkendallbar@ucsd.edu
      orcid: 0000-0003-4758-1386
      institute:
        - ucsc
        - ucsd
  - John Q. Doe:
...
csl: "../templates/sleep.csl" # Insert path for the bib-style
abstract: |
  Text of abstract
keywords: |
...
metadata <- read.csv(here::here('analysis/data/raw_data/00_Sleep_Study_Metadata.csv'))
```
